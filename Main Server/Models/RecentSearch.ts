...
export interface RecentSearchCreationAttributes extends Optional<
  RecentSearchAttributes,
  "id" | "createdat"
> {}

export class RecentSearch
  extends Model<RecentSearchAttributes, RecentSearchCreationAttributes>
  implements RecentSearchAttributes
{
  declare id: string;
