...
import { setKey, getKey, deleteKey, incr, exists } from '../config/redis';
import { TEST_PHONES, TEST_OTP } from '../config/constants';
...
export { generateOTP, storeOTP, verifyOTP, deleteOTP, otpExists, OTP_TTL, OTP_MAX_ATTEMPTS };
