...
const createComplaint = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const authReq = req;
    const result = await complaintService.create(String(authReq.user?.id), req.body);
    auditService.markResource(res, { type: 'complaint', id: result.complaint.id });
    (0, httpResponse_1.successResponse)(res, result);
});
exports.createComplaint = createComplaint;
exports.default = { createComplaint };
