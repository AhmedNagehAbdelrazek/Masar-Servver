...
const createRating = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const authReq = req;
    const result = await ratingService.create(String(authReq.user?.id), req.body);
    auditService.markResource(res, { type: 'rating', id: result.rating.id });
