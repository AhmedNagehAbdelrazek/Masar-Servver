...
function migrationSteps(queryInterface) {
    return [
        ...
        function () {
            return queryInterface.sequelize.query('CREATE UNIQUE INDEX IF NOT EXISTS "idx_subscriptions_unique_pending" ON "driver_subscriptions" ("driver_id", "plan_id") WHERE "status" = \'pending_approval\'');
        },
        // CHECK constraints
        function () {
...
//# sourceMappingURL=005-subscription-plans.js.map