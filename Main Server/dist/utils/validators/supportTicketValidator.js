...
exports.createTicketValidation = [
    (0, express_validator_1.body)('category')
        .notEmpty().withMessage(validation_keys_1.default.CATEGORY_IS_REQUIRED_2)
        .isString().trim().isLength({ max: 50 }).withMessage(validation_keys_1.default.CATEGORY_MUST_BE_AT_MOST_50_CHARACTERS),
    (0, express_validator_1.body)('subject')
        .notEmpty().withMessage(validation_keys_1.default.SUBJECT_IS_REQUIRED)
        .isString().trim().isLength({ max: 150 }).withMessage(validation_keys_1.default.SUBJECT_MUST_BE_AT_MOST_150_CHARACTERS),
    (0, express_validator_1.body)('description')
        .notEmpty().withMessage(validation_keys_1.default.DESCRIPTION_IS_REQUIRED_2)
        .isString().trim().isLength({ max: 5000 }).withMessage(validation_keys_1.default.DESCRIPTION_MUST_BE_AT_MOST_5000_CHARACTERS),
    (0, express_validator_1.body)('priority')
        .optional()
        .isIn(Object.values(constants_1.TICKET_PRIORITY)).withMessage(validation_keys_1.default.PRIORITY_MUST_BE_ONE_OF_LOW_MEDIUM_HIGH_URGENT),
    (0, express_validator_1.body)('booking_id')
        .optional()
        .isUUID().withMessage(validation_keys_1.default.BOOKING_ID_MUST_BE_A_VALID_UUID_2),
...
exports.listTicketsValidation = [
    (0, express_validator_1.query)('status')
        .optional()
        .isIn(Object.values(constants_1.TICKET_STATUS)).withMessage(validation_keys_1.default.STATUS_MUST_BE_ONE_OF_OPEN_IN_PROGRESS_RESOLVED_CLOSED),
...
exports.updateTicketValidation = [
    ...
    (0, express_validator_1.body)('assigned_to')
        .optional()
        .isUUID().withMessage(validation_keys_1.default.ASSIGNED_TO_MUST_BE_A_VALID_UUID),
    (0, express_validator_1.body)('priority')
        .optional()
        .isIn(Object.values(constants_1.TICKET_PRIORITY)).withMessage(validation_keys_1.default.PRIORITY_MUST_BE_ONE_OF_LOW_MEDIUM_HIGH_URGENT),
    (0, express_validator_1.body)('category')
    ...
    (0, express_validator_1.body)('resolution_notes')
        .optional()
        .isString().trim().isLength({ max: 4000 }).withMessage(validation_keys_1.default.RESOLUTION_NOTES_MUST_BE_AT_MOST_4000_CHARACTERS),
];
exports.updateTicketStatusValidation = [
    ...exports.ticketParamValidation,
    (0, express_validator_1.body)('status')
        .notEmpty().withMessage(validation_keys_1.default.STATUS_IS_REQUIRED_2)
        .isIn(Object.values(constants_1.TICKET_STATUS)).withMessage(validation_keys_1.default.STATUS_MUST_BE_ONE_OF_OPEN_IN_PROGRESS_RESOLVED_CLOSED),
];
exports.addMessageValidation = [
    ...exports.ticketParamValidation,
    (0, express_validator_1.body)('message')
        .notEmpty().withMessage(validation_keys_1.default.MESSAGE_IS_REQUIRED)
        .isString().trim().isLength({ max: 4000 }).withMessage(validation_keys_1.default.MESSAGE_MUST_BE_AT_MOST_4000_CHARACTERS),
];
