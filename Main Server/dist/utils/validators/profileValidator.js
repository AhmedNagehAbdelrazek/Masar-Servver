...
exports.updateDriverPersonalDataValidation = [
    (0, express_validator_1.body)('full_name')
        .optional()
        .trim()
        .isLength({ min: 3, max: 120 }).withMessage(validation_keys_1.default.FULL_NAME_MUST_BE_3_120_CHARACTERS),
    (0, express_validator_1.body)('display_name')
        .optional({ nullable: true })
        .trim()
        .isLength({ max: 120 }).withMessage(validation_keys_1.default.DISPLAY_NAME_MUST_BE_AT_MOST_120_CHARACTERS),
    (0, express_validator_1.body)('email')
        .optional({ nullable: true })
        .trim()
        .isEmail().withMessage(validation_keys_1.default.EMAIL_MUST_BE_A_VALID_EMAIL_ADDRESS_2)
        .normalizeEmail(),
    (0, express_validator_1.body)('phone')
        .optional()
        .trim()
        .notEmpty().withMessage(validation_keys_1.default.PHONE_CANNOT_BE_EMPTY),
    ...
    (0, express_validator_1.body)('avatar_url')
        .optional({ nullable: true })
        .isString().withMessage(validation_keys_1.default.AVATAR_URL_MUST_BE_A_STRING),
    ...
    (0, express_validator_1.body)('vehicle')
        .optional()
        .isObject().withMessage(validation_keys_1.default.VEHICLE_MUST_BE_AN_OBJECT_2),
    (0, express_validator_1.body)('vehicle.manufacturer')
        .optional()
        .trim()
        .isLength({ min: 2, max: 60 }).withMessage(validation_keys_1.default.MANUFACTURER_MUST_BE_2_60_CHARACTERS),
    (0, express_validator_1.body)('vehicle.model')
        .optional()
        .trim()
        .isLength({ min: 1, max: 60 }).withMessage(validation_keys_1.default.MODEL_MUST_BE_1_60_CHARACTERS),
    (0, express_validator_1.body)('vehicle.model_year')
        .optional()
        .isInt({ min: 1990, max: 2100 }).withMessage(validation_keys_1.default.MODEL_YEAR_MUST_BE_A_VALID_YEAR),
    (0, express_validator_1.body)('vehicle.color')
        .optional({ nullable: true })
        .trim()
        .isLength({ max: 40 }).withMessage(validation_keys_1.default.COLOR_MUST_BE_AT_MOST_40_CHARACTERS),
    (0, express_validator_1.body)('vehicle.plate_number')
        .optional()
        .trim()
        .isLength({ min: 3, max: 20 }).withMessage(validation_keys_1.default.PLATE_NUMBER_MUST_BE_3_20_CHARACTERS),
    (0, express_validator_1.body)('vehicle.total_seats')
        .optional()
        .isInt({ min: 1, max: 15 }).withMessage(validation_keys_1.default.TOTAL_SEATS_MUST_BE_BETWEEN_1_AND_15),
];
exports.updatePassengerProfileValidation = [
    (0, express_validator_1.body)('preferred_gender')
        .optional()
        .isIn(['male', 'female', 'any']).withMessage(validation_keys_1.default.PREFERRED_GENDER_MUST_BE_MALE_FEMALE_OR_ANY),
    (0, express_validator_1.body)('smoking_preference')
        .optional()
        .isIn(['no_preference', 'non_smoking', 'smoking_allowed']).withMessage(validation_keys_1.default.SMOKING_PREFERENCE_MUST_BE_ONE_OF_NO_PREFERENCE_NON_SMOKING_SMOKING_ALLOWED),
    (0, express_validator_1.body)('national_id')
        .optional()
        .trim()
        .isLength({ min: 5, max: 30 }).withMessage(validation_keys_1.default.NATIONAL_ID_MUST_BE_5_30_CHARACTERS),
    ...
    (0, express_validator_1.body)('saved_routes')
        .optional()
        .isArray().withMessage(validation_keys_1.default.SAVED_ROUTES_MUST_BE_AN_ARRAY),
    (0, express_validator_1.body)('emergency_contacts')
        .optional()
        .isArray().withMessage(validation_keys_1.default.EMERGENCY_CONTACTS_MUST_BE_AN_ARRAY),
];
