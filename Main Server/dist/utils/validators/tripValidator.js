...
exports.createTripValidation = [
    (0, express_validator_1.body)('origin_city')
        .trim()
        .notEmpty().withMessage(validation_keys_1.default.ORIGIN_CITY_IS_REQUIRED_2)
        .isLength({ max: 100 }).withMessage(validation_keys_1.default.ORIGIN_CITY_MUST_BE_AT_MOST_100_CHARACTERS),
    (0, express_validator_1.body)('origin_area')
        .optional()
        .trim()
        .isLength({ max: 120 }).withMessage(validation_keys_1.default.ORIGIN_AREA_MUST_BE_AT_MOST_120_CHARACTERS),
    (0, express_validator_1.body)('origin_lat')
        .optional()
        .isDecimal().withMessage(validation_keys_1.default.ORIGIN_LATITUDE_MUST_BE_A_DECIMAL)
        .custom((value) => {
    ...
    (0, express_validator_1.body)('origin_lng')
        .optional()
        .isDecimal().withMessage(validation_keys_1.default.ORIGIN_LONGITUDE_MUST_BE_A_DECIMAL)
        .custom((value) => {
    ...
    (0, express_validator_1.body)('destination_city')
        .trim()
        .notEmpty().withMessage(validation_keys_1.default.DESTINATION_CITY_IS_REQUIRED_2)
        .isLength({ max: 100 }).withMessage(validation_keys_1.default.DESTINATION_CITY_MUST_BE_AT_MOST_100_CHARACTERS),
    (0, express_validator_1.body)('destination_area')
        .optional()
        .trim()
        .isLength({ max: 120 }).withMessage(validation_keys_1.default.DESTINATION_AREA_MUST_BE_AT_MOST_120_CHARACTERS),
    (0, express_validator_1.body)('destination_lat')
        .optional()
        .isDecimal().withMessage(validation_keys_1.default.DESTINATION_LATITUDE_MUST_BE_A_DECIMAL)
        .custom((value) => {
        const lat = parseFloat(String(value));
        if (lat < -90 || lat > 90)
            throw new Error(validation_keys_1.default.DESTINATION_LATITUDE_MUST_BE_BETWEEN_90_AND_90);
        return true;
    }),
    (0, express_validator_1.body)('destination_lng')
        .optional()
        .isDecimal().withMessage(validation_keys_1.default.DESTINATION_LONGITUDE_MUST_BE_A_DECIMAL)
        .custom((value) => {
        const lng = parseFloat(String(value));
        if (lng < -180 || lng > 180)
            throw new Error(validation_keys_1.default.DESTINATION_LONGITUDE_MUST_BE_BETWEEN_180_AND_180);
        return true;
    }),
    (0, express_validator_1.body)('waypoints')
        .optional()
        .isArray().withMessage(validation_keys_1.default.WAYPOINTS_MUST_BE_AN_ARRAY),
    ...
    (0, express_validator_1.body)('departure_date')
        ...
        if (date < today)
            throw new Error(validation_keys_1.default.DEPARTURE_DATE_MUST_BE_TODAY_OR_IN_THE_FUTURE);
        return true;
    }),
    (0, express_validator_1.body)('departure_time')
        .notEmpty().withMessage(validation_keys_1.default.DEPARTURE_TIME_IS_REQUIRED)
        .matches(/^([01]\d|2[0-3]):([0-5]\d)$/).withMessage(validation_keys_1.default.DEPARTURE_TIME_MUST_BE_IN_HH_MM_FORMAT),
    (0, express_validator_1.body)('type_of_trip')
        .notEmpty().withMessage(validation_keys_1.default.TRIP_TYPE_IS_REQUIRED)
        .isIn(['once', 'repeated']).withMessage(validation_keys_1.default.TRIP_TYPE_MUST_BE_ONCE_OR_REPEATED),
    (0, express_validator_1.body)('repeated_days')
        .if((0, express_validator_1.body)('type_of_trip').equals('repeated'))
        .notEmpty().withMessage(validation_keys_1.default.REPEATED_DAYS_ARE_REQUIRED_FOR_RECURRING_TRIPS)
        .isArray({ min: 1 }).withMessage(validation_keys_1.default.AT_LEAST_ONE_DAY_MUST_BE_SELECTED)
        .custom((days) => {
        if (!Array.isArray(days) || !days.every((d) => Number.isInteger(d) && d >= 0 && d <= 6)) {
            throw new Error(validation_keys_1.default.REPEATED_DAYS_MUST_BE_INTEGERS_BETWEEN_0_SUNDAY_AND_6_SATURDAY);
        }
        return true;
    }),
    (0, express_validator_1.body)('repeated_end_date')
        .if((0, express_validator_1.body)('type_of_trip').equals('repeated'))
        .notEmpty().withMessage(validation_keys_1.default.END_DATE_IS_REQUIRED_FOR_RECURRING_TRIPS)
        .isDate().withMessage(validation_keys_1.default.END_DATE_MUST_BE_A_VALID_DATE)
        .custom((value, { req }) => {
        const endDate = new Date(`${String(value)}T00:00:00`);
        const startDate = new Date(`${req.body.departure_date}T00:00:00`);
        if (endDate <= startDate)
            throw new Error(validation_keys_1.default.END_DATE_MUST_BE_AFTER_DEPARTURE_DATE);
        return true;
    }),
    (0, express_validator_1.body)('allowed_type')
        .optional()
        .isIn(Object.values(constants_1.GENDER_PREFERENCE)).withMessage(validation_keys_1.default.ALLOWED_TYPE_MUST_BE_ONE_OF_ALL_WOMEN_ONLY_MEN_ONLY),
    (0, express_validator_1.body)('fare_per_seat')
        .notEmpty().withMessage(validation_keys_1.default.FARE_PER_SEAT_IS_REQUIRED)
        .isDecimal({ decimal_digits: '1,2' }).withMessage(validation_keys_1.default.FARE_MUST_BE_A_DECIMAL_WITH_UP_TO_2_DECIMAL_PLACES)
        .custom((value) => {
        if (parseFloat(String(value)) < 0)
            throw new Error(validation_keys_1.default.FARE_CANNOT_BE_NEGATIVE);
        return true;
    }),
    (0, express_validator_1.body)('seats')
        .notEmpty().withMessage(validation_keys_1.default.SEATS_CONFIGURATION_IS_REQUIRED)
        .isArray({ min: 1 }).withMessage(validation_keys_1.default.AT_LEAST_ONE_SEAT_MUST_BE_CONFIGURED),
    ...
    (0, express_validator_1.body)('seats.*.type')
        .isIn(['driver', 'available', 'unavailable']).withMessage(validation_keys_1.default.SEAT_TYPE_MUST_BE_DRIVER_AVAILABLE_OR_UNAVAILABLE),
    (0, express_validator_1.body)('instructions')
        .optional()
        .isArray({ min: 1 }).withMessage(validation_keys_1.default.INSTRUCTIONS_MUST_BE_A_NON_EMPTY_ARRAY)
        .custom((arr) => {
        if (!Array.isArray(arr) || !arr.every((item) => typeof item === 'string' && item.trim().length > 0 && item.trim().length <= 1000)) {
            throw new Error(validation_keys_1.default.EACH_INSTRUCTION_MUST_BE_A_NON_EMPTY_STRING_OF_AT_MOST_1000);
        }
        return true;
    })
    ...
    (0, express_validator_1.body)('additional_instructions')
        .optional()
        .trim()
        .isLength({ max: 1000 }).withMessage(validation_keys_1.default.ADDITIONAL_INSTRUCTIONS_MUST_BE_AT_MOST_1000_CHARACTERS),
];
exports.searchAvailableTripsValidation = [
    ...
    (0, express_validator_1.query)('gender_preference')
        .optional()
        .isIn(Object.values(constants_1.GENDER_PREFERENCE)).withMessage(validation_keys_1.default.GENDER_PREFERENCE_MUST_BE_ONE_OF_ALL_WOMEN_ONLY_MEN_ONLY),
    ...
    (0, express_validator_1.query)('time_to')
        ...
        if (req.query.time_from && String(value) < String(req.query.time_from)) {
            throw new Error(validation_keys_1.default.TIME_FROM_AFTER_TIME_TO);
        }
        return true;
    }),
    (0, express_validator_1.query)('vehicle_type')
        .optional()
        .isIn(Object.values(constants_1.VEHICLE_TYPES)).withMessage(validation_keys_1.default.VEHICLE_TYPE_MUST_BE_ONE_OF_SEDAN_SUV_VAN_BUS_HATCHBACK),
...
exports.updateTripValidation = [
    ...
    (0, express_validator_1.body)('departure_time')
        .optional()
        .isISO8601().withMessage(validation_keys_1.default.DEPARTURE_TIME_MUST_BE_A_VALID_ISO_8601_DATETIME)
        .custom((value) => {
        if (new Date(String(value)) <= new Date())
            throw new Error(validation_keys_1.default.DEPARTURE_TIME_MUST_BE_IN_THE_FUTURE);
        return true;
    }),
    (0, express_validator_1.body)('arrival_time')
        .optional()
        .isISO8601().withMessage(validation_keys_1.default.ARRIVAL_TIME_MUST_BE_A_VALID_ISO_8601_DATETIME),
    (0, express_validator_1.body)('gender_preference')
        .optional()
        .isIn(Object.values(constants_1.GENDER_PREFERENCE)).withMessage(validation_keys_1.default.GENDER_PREFERENCE_MUST_BE_ONE_OF_ALL_WOMEN_ONLY_MEN_ONLY),
    (0, express_validator_1.body)('driver_instructions')
        .optional()
        .isArray().withMessage(validation_keys_1.default.DRIVER_INSTRUCTIONS_MUST_BE_AN_ARRAY)
        .custom((arr) => {
        if (!Array.isArray(arr) || !arr.every((item) => typeof item === 'string' && item.trim().length > 0 && item.trim().length <= 1000)) {
            throw new Error(validation_keys_1.default.EACH_INSTRUCTION_MUST_BE_A_NON_EMPTY_STRING_OF_AT_MOST_1000);
        }
    ...
    (0, express_validator_1.body)('attributes')
        .optional()
        .isArray().withMessage(validation_keys_1.default.ATTRIBUTES_MUST_BE_AN_ARRAY),
    (0, express_validator_1.body)('attributes.*.attr_key')
        .optional()
        .isIn(TRIP_ATTR_KEYS).withMessage(validation_keys_1.default.ATTRIBUTE_KEY_MUST_BE_ONE_OF_SMOKING_ALLOWED_WOMEN_ONLY_AC_PETS),
    (0, express_validator_1.body)('attributes.*.attr_value')
        .optional()
        .isIn(['true', 'false', 'yes', 'no']).withMessage(validation_keys_1.default.ATTRIBUTE_VALUE_MUST_BE_TRUE_FALSE_YES_NO),
    ...
    (0, express_validator_1.body)('stops.*.estimated_arrival')
        .optional()
        .isISO8601().withMessage(validation_keys_1.default.ESTIMATED_ARRIVAL_MUST_BE_A_VALID_ISO_8601_DATETIME),
];
exports.cancelTripValidation = [
    ...
    (0, express_validator_1.body)('reason')
        .trim()
        .notEmpty().withMessage(validation_keys_1.default.CANCELLATION_REASON_IS_REQUIRED)
        .isLength({ max: 500 }).withMessage(validation_keys_1.default.REASON_MUST_BE_AT_MOST_500_CHARACTERS),
    (0, express_validator_1.body)('note')
        .optional()
        .trim()
        .isLength({ max: 500 }).withMessage(validation_keys_1.default.NOTE_MUST_BE_AT_MOST_500_CHARACTERS),
];
