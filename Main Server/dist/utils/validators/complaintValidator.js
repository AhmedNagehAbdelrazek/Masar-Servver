...
exports.complaintValidation = [
    (0, express_validator_1.body)('accused_id')
        .isUUID().withMessage(validation_keys_1.default.ACCUSED_USER_ID_MUST_BE_A_VALID_UUID)
        .custom((value, { req }) => {
        if (req.user && req.user.id === value) {
            throw new Error(validation_keys_1.default.YOU_CANNOT_FILE_A_COMPLAINT_AGAINST_YOURSELF);
        }
        return true;
    }),
    ...
    (0, express_validator_1.body)('category')
        .notEmpty().withMessage(validation_keys_1.default.CATEGORY_IS_REQUIRED)
        .isIn(COMPLAINT_CATEGORIES).withMessage(validation_keys_1.default.CATEGORY_MUST_BE_ONE_OF_NO_SHOW_LATENESS_MISCONDUCT_FRAUD_SAFETY_OVERCHARGING),
    (0, express_validator_1.body)('description')
        .notEmpty().withMessage(validation_keys_1.default.DESCRIPTION_IS_REQUIRED)
        .isLength({ max: 2000 }).withMessage(validation_keys_1.default.DESCRIPTION_MUST_BE_AT_MOST_2000_CHARACTERS),
    (0, express_validator_1.body)('evidence_urls')
        .optional()
        .isArray().withMessage(validation_keys_1.default.EVIDENCE_URLS_MUST_BE_AN_ARRAY)
        .custom((arr) => {
        if (!Array.isArray(arr) || !arr.every((u) => typeof u === 'string' && /^https?:\/\//.test(u))) {
            throw new Error(validation_keys_1.default.EACH_EVIDENCE_URL_MUST_BE_A_VALID_HTTP_S_URL);
        }
        return true;
    }),
];
exports.driverComplaintListValidation = [
    (0, express_validator_1.query)('direction')
        .optional()
        .isIn(['filed', 'against']).withMessage(validation_keys_1.default.DIRECTION_MUST_BE_FILED_OR_AGAINST),
    (0, express_validator_1.query)('status')
        .optional()
        .isIn(Object.values(constants_1.COMPLAINT_STATUS)).withMessage(validation_keys_1.default.STATUS_MUST_BE_ONE_OF_OPEN_REVIEWING_RESOLVED_DISMISSED),
...
exports.resolveComplaintValidation = [
    ...
    (0, express_validator_1.body)('status')
        ...
        .withMessage(validation_keys_1.default.STATUS_MUST_BE_ONE_OF_REVIEWING_RESOLVED_DISMISSED),
    (0, express_validator_1.body)('resolution')
        .custom((value, { req }) => {
        if (req.body.status === constants_1.COMPLAINT_STATUS.RESOLVED && !value) {
            throw new Error(validation_keys_1.default.RESOLUTION_IS_REQUIRED_WHEN_RESOLVING_A_COMPLAINT);
        }
        return true;
    })
        .isLength({ max: 2000 }).withMessage(validation_keys_1.default.RESOLUTION_MUST_BE_AT_MOST_2000_CHARACTERS),
];
