...
exports.adminUserListValidation = [
    (0, express_validator_1.query)('role')
        .optional()
        .isIn(Object.values(constants_1.ROLES)).withMessage(validation_keys_1.VALIDATION_KEYS.ROLE_MUST_BE_ONE_OF_PASSENGER_DRIVER_ADMIN_SUPPORT_MODERATOR),
    (0, express_validator_1.query)('status')
        .optional()
        .isIn(Object.values(constants_1.USER_STATUS)).withMessage(validation_keys_1.VALIDATION_KEYS.STATUS_MUST_BE_ONE_OF_ACTIVE_WARNED_SUSPENDED_BANNED),
...
exports.updateUserStatusValidation = [
    (0, express_validator_1.param)('user_id').isUUID().withMessage(validation_keys_1.VALIDATION_KEYS.USER_ID_MUST_BE_A_VALID_UUID),
    (0, express_validator_1.body)('status')
        .notEmpty().withMessage(validation_keys_1.VALIDATION_KEYS.STATUS_IS_REQUIRED)
        .isIn(Object.values(constants_1.USER_STATUS)).withMessage(validation_keys_1.VALIDATION_KEYS.STATUS_MUST_BE_ONE_OF_ACTIVE_WARNED_SUSPENDED_BANNED),
    (0, express_validator_1.body)('reason')
        .optional()
        .isString().trim().isLength({ max: 500 }).withMessage(validation_keys_1.VALIDATION_KEYS.REASON_MUST_BE_A_STRING_500_CHARACTERS),
];
exports.moderateTripValidation = [
    ...
    (0, express_validator_1.body)('action')
        .notEmpty().withMessage(validation_keys_1.VALIDATION_KEYS.ACTION_IS_REQUIRED)
        .isIn(['unpublish', 'block', 'restore']).withMessage(validation_keys_1.VALIDATION_KEYS.ACTION_MUST_BE_ONE_OF_UNPUBLISH_BLOCK_RESTORE),
    (0, express_validator_1.body)('reason')
        .optional()
        .isString().trim().isLength({ max: 500 }).withMessage(validation_keys_1.VALIDATION_KEYS.REASON_MUST_BE_A_STRING_500_CHARACTERS),
];
