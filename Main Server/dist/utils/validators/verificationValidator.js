...
exports.verificationQueueValidation = [
    (0, express_validator_1.query)('status')
        .optional()
        .isIn(['pending', 'approved', 'rejected', 'unverified']).withMessage(validation_keys_1.default.STATUS_MUST_BE_ONE_OF_PENDING_APPROVED_REJECTED_UNVERIFIED),
    (0, express_validator_1.query)('search')
        .optional()
        .isString().withMessage(validation_keys_1.default.SEARCH_MUST_BE_A_STRING)
        .trim()
        .isLength({ max: 100 }).withMessage(validation_keys_1.default.SEARCH_MUST_BE_AT_MOST_100_CHARACTERS),
...
exports.vehicleParamValidation = [
    (0, express_validator_1.param)('vehicle_id')
        .isUUID().withMessage(validation_keys_1.default.VEHICLE_ID_MUST_BE_A_VALID_UUID),
];
exports.rejectValidation = [
    ...
    (0, express_validator_1.body)('fields_to_fix')
        .isArray({ min: 1 }).withMessage(validation_keys_1.default.FIELDS_TO_FIX_MUST_BE_A_NON_EMPTY_ARRAY)
        .custom((value) => Array.isArray(value) && value.every((field) => constants_1.VERIFICATION_FIELD_KEYS.includes(field)))
        .withMessage(validation_keys_1.default.FIELDS_TO_FIX_MUST_ONLY_CONTAIN_ALLOWED_KEYS_NATIONAL_ID_LICENSE_PERSONAL),
];
