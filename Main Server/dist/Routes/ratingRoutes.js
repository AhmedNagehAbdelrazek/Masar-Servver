...
const c = __importStar(require("../Controllers/ratingController"));
...
router.post('/', protect_1.default, ...ratingValidator_1.ratingValidation, validatorMiddleware_1.default, c.createRating);
