...
const { registerPhoneValidation, verifyOTPValidation, registerPasswordValidation, loginValidation, forgotPasswordValidation, resetPasswordValidation, resendOTPValidation, refreshValidation, changePasswordValidation, onboardingProfileValidation, onboardingPassengerProfileValidation, onboardingVehicleValidation, } = require('../utils/validators/authValidator');
// Registration
