...
const c = __importStar(require("../Controllers/subscriptionController"));
const subscriptionValidator_1 = require("../utils/validators/subscriptionValidator");
const driver = [protect_1.default, (0, roleGuard_1.roleGuard)(['driver'])];
router.post('/', ...driver, ...subscriptionValidator_1.createSubscriptionValidation, validatorMiddleware_1.default, c.createSubscription);
