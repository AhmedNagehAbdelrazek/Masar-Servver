...
const c = __importStar(require("../Controllers/complaintController"));
...
router.post('/', protect_1.default, ...complaintValidator_1.complaintValidation, validatorMiddleware_1.default, c.createComplaint);
