...
const { User, Vehicle, Trip, TripSeat, TripStop, Booking, SubscriptionPlan, DriverSubscription, PaymentMethod, UploadedImage, } = require('../../Models');
...
async function syncTotal(driverId) {
    ...
    await User.update({ totalBalance: total, isInDebt: total < 0 }, { where: { id: driverId } });
    return total;
}
