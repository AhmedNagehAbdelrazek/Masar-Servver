...
const { User, Vehicle, DriverProfile, Notification, VerificationStatusChange, } = require('../../Models');
...
async function seedApprovedDriver() {
    ...
    await User.update({ verificationStatus: 'approved', isVerified: true }, { where: { id: DRIVER_ID } });
}
...
//# sourceMappingURL=driverVerification.test.js.map