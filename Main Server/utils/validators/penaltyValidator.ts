import { body, query, ValidationChain, Meta } from 'express-validator';
import { PENALTY_TYPES } from '../../config/constants';
import V from '../../config/messages/validation-keys';

export const penaltyListValidation: ValidationChain[] = [
  query('active')
    .optional()
...
export const penaltyValidation: ValidationChain[] = [
  body('user_id')
...
const _exported = { penaltyListValidation, penaltyValidation };
...
if (typeof module !== 'undefined' && module.exports) {
  // @ts-ignore
  module.exports = { penaltyListValidation, penaltyValidation };
  // @ts-ignore
  module.exports.penaltyListValidation = penaltyListValidation;
  // @ts-ignore
  module.exports.penaltyValidation = penaltyValidation;
  // @ts-ignore
