...
export const updateGroupedNotificationValidation: ValidationChain[] = [
  body('master_switch')
    .optional()
    .isBoolean().withMessage(V.MASTER_SWITCH_MUST_BE_A_BOOLEAN)
    .custom((value: unknown, { req }: Meta) => {
      if ((req as unknown as { body: Record<string, unknown> }).body.updates !== undefined) {
...
const _exported = { updateNotificationSettingsValidation, updateGroupedNotificationValidation };
...
if (typeof module !== 'undefined' && module.exports) {
  // @ts-ignore
  module.exports = { updateNotificationSettingsValidation, updateGroupedNotificationValidation };
  // @ts-ignore
  module.exports.updateNotificationSettingsValidation = updateNotificationSettingsValidation;
  // @ts-ignore
