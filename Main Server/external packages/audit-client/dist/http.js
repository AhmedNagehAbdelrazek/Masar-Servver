...
exports.createAuditedFetch = createAuditedFetch;
const context_1 = require("./context");
const ids_1 = require("./ids");
function createAuditedFetch(client) {
    return async function auditedFetch(url, options = {}) {
        const ctx = (0, context_1.getTraceContext)();
        const trace_id = ctx?.trace_id ?? (0, ids_1.generateSpanId)();
        const request_id = ctx?.request_id ?? (0, ids_1.generateRequestId)();
